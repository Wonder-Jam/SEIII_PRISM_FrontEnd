...
const UpdateForm: React.FC<UpdateFormProps> = (props) => {
  ...
  const formRef = useRef<ProFormInstance<any> | null | undefined>();
  formRef.current?.setFieldValue("content", data);
  return (
    <StepsForm
      stepsProps={{
        size: "small",
    ...
    >
      ...
      <StepsForm.StepForm formRef={formRef} name="content" title={"新闻正文"}>
        <ProFormTextArea
          name="content"
          label={"正文"}
          width="md"
